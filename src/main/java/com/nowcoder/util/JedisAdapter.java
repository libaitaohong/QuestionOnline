...
public class JedisAdapter implements InitializingBean {
    ...
    private ConfigUtil config = ConfigUtil.getConfig();
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        jedisPool = new JedisPool("redis://" + config.getREDIS_IP() + ":" + config.getREDIS_PORT());
    }
    ...
    public long sadd(String key, String value) {
        ...
        try {
            ...
            jedis.auth(config.getREDIS_PASSWORD());
